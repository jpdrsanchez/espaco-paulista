<section class="pageGallery">
  <div class="container pageGallery__container">
    <h3 class="preTitle pageGallery__preTitle"><?= $gallerySubtitle; ?></h3>
    <h1 class="siteTitle pageGallery__title"><?= $galleryTitle; ?></h1>
    <p class="siteText pageGallery__text"><?= $galleryText; ?></p>
    <a href="./contato.php" class="siteButton siteButton--black pageGallery__button">
  ...
  <nav class="pageGallery__images" id="gallery">
    <?php foreach($images as $image): ?>
    <a href="<?= $image['link']; ?>" class="pageGallery__images__image">
      <img src="<?= $image['image']; ?>" alt="<?= $image['title']; ?>">
      <div class="pageGallery__images__loupe">
